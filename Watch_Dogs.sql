...
CREATE TABLE `Host_info`  (
  `host_id` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT COMMENT '主机id',
  ...
  `port` tinyint(255) NOT NULL DEFAULT 0 COMMENT '端口',
  ...
  `mem_KB` int(255) NOT NULL DEFAULT 0 COMMENT '内存大小',
...
CREATE TABLE `Host_record`  (
  ...
  `CPUs` json NOT NULL COMMENT 'CPU单核数据',
  `mem` float(255, 0) NOT NULL COMMENT '内存百分比',
  `read_MBs` float(255, 0) NOT NULL COMMENT '读取速度',
  `write_MBs` float(255, 0) NOT NULL COMMENT '写入速度',
  `net_upload_kbps` float(255, 0) NOT NULL COMMENT '上传速度',
  `net_download_kbps` float(255, 0) NOT NULL COMMENT '下载速度',
  `lavg_1` float(255, 0) NOT NULL DEFAULT 0 COMMENT '系统1分钟负载率',
  `lavg_5` float(255, 0) NOT NULL DEFAULT 0 COMMENT '系统5分钟负载率',
  `lavg_15` float(255, 0) NOT NULL DEFAULT 0 COMMENT '系统15分钟负载率',
